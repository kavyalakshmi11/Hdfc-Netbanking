...
a persistence unit "Hdfc_NetbankingPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Hdfc_Netbanking\pom.xml":
...
artifact ("Hdfc_Netbanking.war") is already built. You can build
